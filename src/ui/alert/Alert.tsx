...
const Alert: React.FC<AlertProps> = ({
  ...
  // CSS module classes for each variant
  ...
  return (
    <div className={`${styles.alert} ${variantClasses[variant].container}`}>
      <div className={styles.alertContent}>
        <div className={`${styles.alertIcon} ${variantClasses[variant].icon}`}> 
          {icons[variant]}
        </div>
